	...
	<div class="page-content">
		...
		<!--- Portlet Start For Events -->
			...
			<div class="row ">
				...
				<!--- end Portlet For Events -->
				<!---  Portlet Start For User Request -->
				<div class="col-md-6 col-sm-6">
					<div class="portlet box green-haze tasks-widget">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-check"></i>User Request
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="task-content">
								<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 305px;"><div class="scroller" style="overflow: hidden; width: auto; height: 305px;" data-always-visible="1" data-rail-visible1="1" data-initialized="1">
									...
									<!-- END START TASK LIST -->
								</div><div class="slimScrollBar" style="width: 7px; position: absolute; opacity: 0.4; border-radius: 7px; z-index: 99; left: 1px; top: 0px; height: 195.431px; display: block; background: rgb(187, 187, 187);"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; left: 1px; background: rgb(234, 234, 234);"></div></div>
							</div>
