						...
						<div class="col-md-12 col-sm-8 article-block">
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h1>
									<a href="<?php echo site_url('forum/topic'.'/Filipino')?>">
									Filipino </a>
									</h1>
									<p>
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Filipino')?>">
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h1>
									<a href="<?php echo site_url('forum/topic'.'/English')?>">
									English</a>
									</h1>
									<p>
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/English')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h1>
									<a href="<?php echo site_url('forum/topic'.'/Mathematics')?>">
									Mathematics</a>
									</h1>
									<p>
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Mathematics')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h1>
									<a href="<?php echo site_url('forum/topic'.'/Science/and/Health')?>">
									Science & Health </a>
									</h1>
									<p>
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Science/and/Health')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h3>
									<a href="<?php echo site_url('forum/topic'.'/Heograpiya/Kasaysayan/Sibika')?>">
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Heograpiya/Kasaysayan/Sibika')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h3>
									<a href="<?php echo site_url('forum/topic'.'/Edukasyong/Pantahanan/at/Pangkabuhayan')?>">
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Musika/Sining/at/Edukasyon/sa/Pagpapalakas/ng/Katawan')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									<h3>
									<a href="<?php echo site_url('forum/topic'.'/Character/Education')?>">
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Character/Education')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8 blog-article">
									...
									<a class="btn blue" href="<?php echo site_url('forum/topic'.'/Concern/And/Queries')?>">
									View Topics <i class="m-icon-swapright m-icon-white"></i>
									</a>
								</div>
							</div>
