			...
			<div class="row">
				...
				<div class="portlet box blue-hoki" style="display: block;">
						...
						<div class="portlet-body">
                  		 ...
                  		 <?php if(count($alumni)): foreach($alumni as $alumnus): ?>
							...
							<tr role="row" class="odd">
								...
								<td class="sorting_1">
									<div class="row">
										<div class="col-md-2">
											<img src="<?php echo $alumnus->photo;?>" class="img-responsive" style="height: 28px;width: 36px;">
										</div>
								...
								<td>
									<?php echo $alumnus->firstname;?>
								</td>
								<td>
									<?php echo $alumnus->lastname;?>
								</td>
